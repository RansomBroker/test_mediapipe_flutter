...
class InsertCamera{
  ...
  InputImage? _inputImageFromCameraImage(CameraImage image) {
    ...
    // Safely handle the sensor orientation and get the rotation
    var rotation = InputImageRotationValue.fromRawValue(sensorOrientation);
    if (rotation == null) {
      // Handle cases where the rotation value is not one of the expected values
      rotation = InputImageRotation.rotation0deg; // Default to 0 degrees if invalid
    }
    ...
    return InputImage.fromBytes(
      ...
      metadata: InputImageMetadata(
        ...
        rotation: rotation, // corrected rotation
        format: format,
